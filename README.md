...
pixi add markdown-to-confluence
# for installing globally
pixi global install markdown-to-confluence
```
...
It is possible to list all of the versions of `markdown-to-confluence` available on your platform:
...
```
pixi search markdown-to-confluence --channel conda-forge
```
